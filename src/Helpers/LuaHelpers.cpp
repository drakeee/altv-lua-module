...
{
	lua_pushuserdata(L, lua::Class::MapData::ClassName, mapData, refUserData);
}
...
{
	lua_pushuserdata(L, lua::Class::HandlingData::ClassName, handlingData, refUserData);
}

void lua_pushwebview(lua_State* L, alt::IWebView* webView, bool refUserData)
{
	lua_pushuserdata(L, lua::Class::WebView::ClassName, webView, refUserData);
}
#endif

void lua_pushconfig(lua_State* L, alt::config::Node::Dict* nodeDict, bool refUserData)
{
	lua_pushuserdata(L, lua::Class::Config::ClassName, nodeDict, refUserData);
}
...
{
	lua_pushuserdata(L, lua::Class::Vector2::ClassName, vector, refUserData);
}
...
{
	lua_pushuserdata(L, lua::Class::Vector3::ClassName, vector, refUserData);
}
...
void lua_pushrgba(lua_State* L, const alt::RGBA& color, bool refUserData)
{
	...
	lua_pushuserdata(L, lua::Class::RGBA::ClassName, tempColor, refUserData);
}
...
void lua_pushresource(lua_State* L, alt::IResource* resource, bool refUserData)
{
	if (resource == nullptr)
		...
		lua_pushuserdata(L, lua::Class::Resource::ClassName, resource, refUserData);
}
