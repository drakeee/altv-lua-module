...
int CLuaHandlingDataDefs::SET(lua_State* L) { alt::IHandlingData* handlingData; TYPE value; CArgReader argReader(L); argReader.ReadUserData(handlingData); argReader.READ(value); if (argReader.HasAnyError()) { argReader.GetErrorMessages(); return 0; } handlingData->SET(value); return 0; }
