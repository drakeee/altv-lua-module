...
namespace lua::Class
{
	const char* Native::ClassName = "native";
	void Native::Init(lua_State* L)
	{
		lua_beginclass(L, Native::ClassName);
		{
		...
		lua_beginclass(L, "game", Native::ClassName);
		lua_endclass(L);
	}
	...
	int Native::InvokeNative(lua_State* L)
	{
