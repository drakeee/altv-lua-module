...
xcopy build\win64\Release\lua-client-module-static.dll artifacts\lua-client-module\ /Y

cd artifacts
if not exist "lua-client-module\modules" mkdir "lua-client-module\modules"
